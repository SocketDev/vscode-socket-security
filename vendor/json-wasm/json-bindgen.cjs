...
/**
 * Crate version string, baked at compile time. Useful for
 * downstream consumers that want to assert against a known
 * parser revision.
 * @returns {string}
 */
...
/**
 * Parse a JSON source string into a span-annotated AST.
 * Returns a plain JS object matching `ParsedJson` from
 * `index.d.mts`. Throws on syntax error.
 * @param {string} source
 * @returns {any}
 */
...
const wasmPath = `${__dirname}/./json.wasm`;
